...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Feliz cumpleaños, corazón; hoy el tiempo se detiene un instante para contemplarte, como si el universo mismo recordara el día en que decidió regalarle al mundo una chispa de luz hecha persona. Eres y seras para mi, la niña más maravillosa de todo el universo, te amo <3`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, tú noviecito.";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-05-02T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-05-02T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Llevamos juntitos: <b>${days}</b> días<br>` +
      `Nuestro aniversario de un añito: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
